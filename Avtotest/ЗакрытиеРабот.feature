...
Сценарий: Закрытие работ по обслуживанию
	...
	И в таблице "Список" я перехожу к строке:
		...
		| 'Баблос компани' | 'Абонентское обслуживание промышленного оборудования' | 'Веселов'    | '11.01.2024'            |
	И в таблице "Список" я выбираю текущую строку
	Тогда открылось окно 'Обслуживание клиента * от *'
	И в таблице "ВыполненныеРаботы" я нажимаю на кнопку 'Добавить'
	И в таблице "ВыполненныеРаботы" в поле 'Описание работ' я ввожу текст 'Диагностика'
	...
	И в таблице "Список" я перехожу к строке:
		| 'Клиент'        | 'Договор'                  | 'Специалист' | 'Дата проведения работ' |
		| 'Откат системс' | 'Абонентское обслуживание' | 'Петренко'   | '11.01.2024'            |
	И в таблице "Список" я выбираю текущую строку
	Тогда открылось окно 'Обслуживание клиента * от *'
	И в таблице "ВыполненныеРаботы" я нажимаю на кнопку 'Добавить'
	И в таблице "ВыполненныеРаботы" в поле 'Описание работ' я ввожу текст 'Диагностика'
